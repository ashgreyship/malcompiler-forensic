...
public class Lang {
    ...
    public static class Trace {
        ...
        public Trace(
                String name, TraceType type, Asset asset, AST.ReachTypes inheritsReaches) {
            this.name = name;
            this.type = type;
            this.asset = asset;
            this.inheritsReaches = inheritsReaches;
        ...
        public TTEExpr getTTE() {
            return this.tte;
        }

        public void setTTE(TTEExpr tte) {
            this.tte = tte;
        }
    ...
    public static class TTEExpr {
    }

    public abstract static class TTEBinOp extends TTEExpr {
        public final TTEExpr lhs;
        public final TTEExpr rhs;

        public TTEBinOp(TTEExpr lhs, TTEExpr rhs) {
            this.lhs = lhs;
            this.rhs = rhs;
        }
    }
